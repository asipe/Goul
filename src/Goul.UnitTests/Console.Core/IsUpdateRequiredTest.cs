...
namespace Goul.UnitTests.Console.Core {
  ...
  public class IsUpdateRequiredTest : BaseTestCase {
    ...
    public void TestUpdateOnASingleFileOnRootRegistersAsFalse() {
      ...
      Assert.That(mIsUpdateRequired.Check(mRetrieval.Object.RetrieveFilesFromSpecificDirectory("root"), "file3"), Is.False);
    }

    [Test]
    public void TestUpdateOnASingleFileOnRootRegistersAsTrue() {
      mRetrieval.Setup(r => r.RetrieveFilesFromSpecificDirectory("root")).Returns(new[] {"file1"});
      Assert.That(mIsUpdateRequired.Check(mRetrieval.Object.RetrieveFilesFromSpecificDirectory("root"), "file1"), Is.True);
    }
    ...
    public void TestUpdateOnMultipleFilesOnRootRegistersAsFalse() {
      ...
      Assert.That(mIsUpdateRequired.Check(mRetrieval.Object.RetrieveFilesFromSpecificDirectory("root"), "joe"), Is.False);
    }

    [Test]
    public void TestUpdateOnMultipleFilesOnRootRegistersAsTrue() {
      mRetrieval.Setup(r => r.RetrieveFilesFromSpecificDirectory("root")).Returns(new[] {"file1", "file2", "file3"});
      Assert.That(mIsUpdateRequired.Check(mRetrieval.Object.RetrieveFilesFromSpecificDirectory("root"), "file2"), Is.True);
    }
    ...
    public void TestUpdateOnNoFilesOnRootRegistersAsFalse() {
      ...
      Assert.That(mIsUpdateRequired.Check(mRetrieval.Object.RetrieveFilesFromSpecificDirectory("randomDir"), "file2"), Is.False);
    }
